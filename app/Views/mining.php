...
<?=$this->section('content')?>
	<ul class="collapsible">
		<li class="<?=$proses ? "" : "active"?>">
			<div class="collapsible-header green darken-3 white-text">Form Input</div>
			<div class="collapsible-body green darken-3">
				<div class="card">
	...
	<ul class="collapsible">
		<li class="active">
			<div class="collapsible-header">Hasil Mining</div>
