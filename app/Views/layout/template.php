	...
	<div class="row" style="margin:0px;">
		<div class="col s2" style="padding:0.5em;overflow: hidden">
			<div class="z-depth-3 center-align" style="padding:0.5em" >
				<img src="<?=base_url('assets/img/default.jpeg')?>" alt="" class="circle responsive-img" style="width:100px; border:1px solid black; margin: 10px 0">
				<h6 class="truncate"><?=session()->get('nama')?></h6>
		...
		<div class="col s10" style="height:100vh;padding:0.5em">
			<div class="z-depth-3" style="padding:0.5em; height:100%;overflow-y:scroll; overflow-x:hidden">
